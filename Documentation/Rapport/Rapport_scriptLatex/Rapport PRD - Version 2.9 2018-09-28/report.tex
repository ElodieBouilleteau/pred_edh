...
\institution{LS2N}
   % - LS2N (merging of the former LINA and IRCCyN) when you're supervised by members of the research teams of the department(may be some other teams from LS2N);
...
\date{October 4, 2017}
   % - do not had a 0 in front of the first to ninth day of a month!
...
Besides, the reference is associated to the last sentence rather than the whole paragraph.
...
\begin{figure*}
   \centering
      ...
      \fi
   \caption{Items to be checked at the end of the phase~I}
...
\begin{figure*}
   \centering
      ...
      \fi
   \caption{Items to be checked at the end of the phase~II}
